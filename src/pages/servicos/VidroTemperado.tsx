...
import { ArrowLeft, ArrowRight, Check, Calendar, MessageCircle, ShieldCheck, CheckCircle, Building2 } from 'lucide-react';

const VidroTemperado = () => {
  return (
          ...
          <div className="max-w-[1280px] mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-[18px] leading-[28px] text-white/80 mb-12 max-w-[500px]">
                Trabalhamos com vidro temperado para aplicações residenciais e comerciais, indicado para portas, divisórias, vitrines, painéis e outras estruturas que exigem mais resistência e acabamento profissional.
              </p>
              <div className="flex gap-6">
                <a 
                  href={waLink('Olá! Gostaria de um orçamento para vidro temperado.')}
                  target="_blank"
        ...
        <section className="bg-[#f4f3f3] py-20 border-y border-[#e2e2e2]">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="mb-12 max-w-[700px]">
              <h2 className="font-['Inter'] text-[32px] md:text-[40px] font-bold text-[#1a1c1c] mb-3">Resistência e Acabamento</h2>
              <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                Conheça os principais benefícios ao escolher a Vidraçaria Liderança para o seu projeto de vidro temperado.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Alta Resistência</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Cinco vezes mais resistente que o vidro comum.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CheckCircle className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Acabamento Elegante</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Ideal para ambientes modernos e sofisticados.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Building2 className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Versatilidade</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Excelente para uso residencial e comercial.
                </p>
              </div>
            </div>
          </div>
