...
import { ArrowLeft, ArrowRight, Check, Calendar, MessageCircle, Shield, Eye, Home } from 'lucide-react';
          ...
          <div className="max-w-[1280px] mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-[18px] leading-[28px] text-white/80 mb-12 max-w-[500px]">
                Instalamos guarda-corpo de vidro para escadas, sacadas, mezaninos e áreas elevadas, unindo segurança e visual moderno. Proteção sem comprometer a arquitetura.
              </p>
              <div className="flex gap-6">
                <a 
                  href={waLink('Olá! Gostaria de um orçamento para guarda-corpo de vidro.')}
                  target="_blank"
        ...
        <section className="bg-[#f4f3f3] py-20 border-y border-[#e2e2e2]">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="mb-12 max-w-[700px]">
              <h2 className="font-['Inter'] text-[32px] md:text-[40px] font-bold text-[#1a1c1c] mb-3">Segurança com Leveza Visual</h2>
              <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                Conheça os principais benefícios ao escolher a Vidraçaria Liderança para o seu projeto de guarda-corpo de vidro.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Segurança Máxima</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Uso de vidros adequados para prevenir quedas.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Eye className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Visual Limpo</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Integração perfeita com diversos estilos arquitetônicos.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Home className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Aplicações Diversas</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Ideal para escadas, mezaninos e áreas com desnível.
                </p>
              </div>
            </div>
          </div>
