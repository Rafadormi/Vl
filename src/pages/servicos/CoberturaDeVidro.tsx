...
import { ArrowLeft, ArrowRight, Check, Calendar, MessageCircle, CloudRain, Sun, Star } from 'lucide-react';

const CoberturaDeVidro = () => {
  return (
          ...
          <div className="max-w-[1280px] mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-[18px] leading-[28px] text-white/80 mb-12 max-w-[500px]">
                Instalamos coberturas de vidro para corredores, entradas, áreas gourmet e pergolados, proporcionando proteção sem bloquear a iluminação natural.
              </p>
              <div className="flex gap-6">
                <a 
                  href={waLink('Olá! Gostaria de um orçamento para cobertura de vidro.')}
                  target="_blank"
        ...
        <section className="bg-[#f4f3f3] py-20 border-y border-[#e2e2e2]">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="mb-12 max-w-[700px]">
              <h2 className="font-['Inter'] text-[32px] md:text-[40px] font-bold text-[#1a1c1c] mb-3">Proteção com Luminosidade</h2>
              <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                Conheça os principais benefícios ao escolher a Vidraçaria Liderança para o seu projeto de cobertura de vidro.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CloudRain className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Proteção Contra Intempéries</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Abrigo seguro contra chuva.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Sun className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Claridade Natural</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Luz solar aproveitada ao máximo.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Star className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Estética Premium</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Valoriza áreas externas e de lazer.
                </p>
              </div>
            </div>
          </div>
...
export default CoberturaDeVidro;
