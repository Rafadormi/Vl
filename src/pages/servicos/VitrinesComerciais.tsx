...
import { ArrowLeft, ArrowRight, Check, Calendar, MessageCircle, ShoppingBag, Shield, Wrench } from 'lucide-react';

const VitrinesComerciais = () => {
  return (
          ...
          <div className="max-w-[1280px] mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 flex flex-col items-start z-10">
              ...
              <p className="text-[18px] leading-[28px] text-white/80 mb-12 max-w-[500px]">
                Instalamos vitrines de vidro para lojas e espaços comerciais, ajudando a expor produtos com mais segurança, organização e forte apelo visual.
              </p>
              <div className="flex gap-6">
                <a 
                  href={waLink('Olá! Gostaria de um orçamento para vitrine comercial.')}
                  target="_blank"
            ...
            <div className="w-full md:w-1/2 relative h-[400px] md:h-[600px]">
              <div className="absolute inset-0 bg-[#e8e8e8] rounded-lg overflow-hidden border border-white/10 shadow-2xl">
                <img 
                  alt="Vitrines Comerciais" 
                  className="w-full h-full object-cover object-center" 
                  src="https://images.unsplash.com/photo-1555529733-0e67056058e1?q=80&w=1200&auto=format&fit=crop" 
                />
              </div>
            </div>
          </div>
        ...
        <section className="bg-[#f4f3f3] py-20 border-y border-[#e2e2e2]">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="mb-12 max-w-[700px]">
              <h2 className="font-['Inter'] text-[32px] md:text-[40px] font-bold text-[#1a1c1c] mb-3">Destaque para seus Produtos</h2>
              <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                Conheça os principais benefícios ao escolher a Vidraçaria Liderança para o seu projeto de vitrines comerciais.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <ShoppingBag className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Melhor Exposição</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Valoriza as mercadorias aos olhos do cliente.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Shield className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Mais Segurança</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Vidros adequados para vitrines comerciais.
                </p>
              </div>
              <div className="bg-white p-8 rounded border border-[#e2e2e2] shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <Wrench className="text-[#E60012] h-8 w-8 mb-4" />
                <h3 className="font-['Inter'] text-[24px] font-semibold text-[#1a1c1c] mb-2">Instalação e Reposição</h3>
                <p className="text-[16px] leading-[24px] text-[#5f3f3b]">
                  Atendimento completo para lojas.
                </p>
              </div>
            </div>
          </div>
...
export default VitrinesComerciais;
